    ...
    return(
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(OnSubmit)}>
            ...
            <>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <Input label = 'Reserve Price (Enter 0 if no reserve price)' name='reservePrice' control={control} type='number'
            ...
            <div className='flex justify-between'>
                ...
                <Button isProcessing={isSubmitting} disabled={!isValid} outline color='success'  type='submit'>
                    Submit
                </Button>
            </div>
        </form>
